...
export const propertySchema = z.object({
  ...
  square_feet: z.preprocess((val) => val === "" || val === null || val === undefined ? null : Number(val), z.number().positive().nullable().optional()),
  purchase_date: dateField,
  purchase_price: z.preprocess((val) => val === "" || val === null || val === undefined ? null : Number(val), z.number().positive().nullable().optional()),
  current_value: z.preprocess((val) => val === "" || val === null || val === undefined ? null : Number(val), z.number().positive().nullable().optional()),
...
const vendorSpecialties = [
  ...
  "shoveling", "plowing", "mowing", "attorney", "other"
] as const
